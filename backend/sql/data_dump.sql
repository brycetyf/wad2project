...
INSERT INTO `users` (`unique_id`, `username`, `name`, `url`, `age`, `description`, `ghostRating`, `gender`, `user_indicated_interest`,`reviewInstances`,`userRating`,`userTags`) VALUES
('1', 'Aisah', 'Aisah', 'https://images.unsplash.com/photo-1527047614336-194da60dacd9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60', 23, 'cold jokes only', 0, 'F', b'0',NULL,NULL,NULL),
('2', 'Prapoth', 'Prapoth Panchuea', 'https://images.unsplash.com/photo-1586785772786-a59de185e06a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80', 26, 'i like carousells', 0, 'M', b'0',NULL,NULL,NULL),
('3', 'Sammy', 'Sammy Lee', 'https://images.unsplash.com/photo-1475823678248-624fc6f85785?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1950&q=80', 24, 'here for a good time, not a long time', 1, 'M', b'0',NULL,NULL,NULL),
('4', 'Natalie', 'Natalie Siow', 'https://images.unsplash.com/photo-1500055457707-845bf2958845?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60', 22, 'i like sweet things', 0, 'F', b'1',NULL,NULL,NULL),
('5', 'Joyce', 'Joyce Tan', 'https://images.unsplash.com/photo-1567250671670-05e36d8ca38e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60', 25, 'travelling is bae', 1, 'F', b'1',NULL,NULL,NULL),
('6', 'Lee Min', 'Ang Lee Min', 'https://images.unsplash.com/photo-1527431378753-bd2f0dedc06e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60', 23, 'antique things i love', 0, 'F', b'0',NULL,NULL,NULL),
('7', 'Seanna', 'Seanna Seow', 'https://images.unsplash.com/photo-1498551172505-8ee7ad69f235?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=934&q=80', 22, 'b&w times', 2, 'M', b'0',NULL,NULL,NULL),
('8', 'Tammy', 'Tammy Ong', 'https://images.unsplash.com/photo-1514883718278-c239aeaf86df?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60', 24, 'dont look back in anger', 2, 'F', b'0',NULL,NULL,NULL);
