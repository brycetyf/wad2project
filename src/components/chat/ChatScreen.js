...
function ChatScreen() {
  ...
  const [messages, setMessages] = useState({
    ...
    // the data structure i suka suka put first just to get the layout rolling
    Elon: [
      {
        name: "Elon Musk",
        image:
    ...
    Mark: [
      {
        ...
        message: "Can I have your personal data",
        match_date: "10/08/20",
      },
    ],
    Steve: [
      {
        ...
        message: "Sending my greetings from the underworld",
        match_date: "10/08/20",
      },
    ],
  });

  var partner_msg = messages[partner_name];
  console.log(partner_msg);

  const handleSend = (e) => {
    e.preventDefault();
    // setMessages([...messages, { partner_msg:{message : input }}]); <-- aku noob dk how to use set in React
    partner_msg.push({ message: input });
    setInput("");
  };
  ...
  return (
    <div className="chatScreen">
      <p className="chatScreen__timestamp">
        YOU MATCHED WITH {partner_msg[0].name.toUpperCase()} ON{" "}
